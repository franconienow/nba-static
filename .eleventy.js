...
module.exports = function(eleventyConfig) {
  ...
  eleventyConfig.addLayoutAlias("players", "layouts/players.njk");
  eleventyConfig.addLayoutAlias("teams", "layouts/teams.njk");
  eleventyConfig.addLayoutAlias("team", "layouts/team.njk");
